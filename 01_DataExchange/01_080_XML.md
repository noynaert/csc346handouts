...
| :--------------------------------- | :-------------------------------------------------------------------------------------------------------------------------------------- |
| Transmitting data between systems. | It is, in effect, **_serializable_** data that may be transmitted between applications. It is better than JSON and Java Serialized data |
...
- Character set
  ...
  - &amp; and &lt; may not appear in XML except as escape characters By the way, &lt; also is problematic in Markdown.
...
* Attributes are sometimes harder to access in code (What are your experiences with your packages?)
